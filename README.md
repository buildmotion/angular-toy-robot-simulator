...
> Please open the `workspace` folder in Visual Studio Code to view the workspace. The Nx Workspace (i.e., monorepo) references the configuration files and projects from the root folder.
