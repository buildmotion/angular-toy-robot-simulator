      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build toy-robot-ui
<span># Test</span>
nx test toy-robot-ui
<span># Lint</span>
nx lint toy-robot-ui
<span># Run them together!</span>
nx run-many -p toy-robot-ui -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project toy-robot-ui</pre>
          </details>
