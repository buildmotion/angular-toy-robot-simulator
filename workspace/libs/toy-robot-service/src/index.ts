export * from './lib/toy-robot-service.module';

export { Direction, RobotContext, DIRECTIONS, MOVES } from './lib/models/robot-context.model';

export { RobotPosition } from './lib/models/robot-position.model';
